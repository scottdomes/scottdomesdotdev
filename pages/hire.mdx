...
My current position is with [Scribd](https://www.scribd.com/), working for the SlideShare team. Scribd does not have a quarterly peer review process, so I don't have many good quotes to share, but here's a sample of the projects I've worked on:
