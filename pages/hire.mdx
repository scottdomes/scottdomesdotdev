...
export const meta = {
  ...
  description: "A little about me & how I could contribute to your team",
};
...
After leaving Indeed, I joined an early-stage startup as a founding engineer, but left when it wasn't a great fit for me. Since then, I've done some contracting, but mostly took a mini-sabbatical to think about my next steps.
...
My current position is with [Scribd](https://www.scribd.com/), working for the SlideShare team. Scribd does not have a peer review process, so I don't have good quotes to share, but here's a sample of the projects I've worked on:

- Rearchitecting a jQuery+spaghetti code frontend into a well-tested React app (ongoing), taking the project from technical design to implementation
- Building an end to end testing suite using Cypress
- Doing a complete rewrite of major parts of the site, including the upload flow and slideshow player
- Implementing several full stack features that helped the site integrate better with Scribd
- Implementing Sentry for the frontend for better insight into errors
...
To see all my articles, visit my [Medium page](https://scottdomes.medium.com/). You can also see some of my best writing at the [the homepage of this site](/) or via the [Articles page](/articles).

Aside from short pieces, I also published a book called [Progressive Web Apps with React](https://www.amazon.ca/Progressive-Web-Apps-React-lightning-ebook/dp/B076SZY9P9).
...
Thanks for reading. You can reach me via [LinkedIn](https://www.linkedin.com/in/scottdomes/). Let's build something amazing.

export default ({ children }) => (
  <ArticleLayout noEmail meta={meta}>{children}</ArticleLayout>
);
