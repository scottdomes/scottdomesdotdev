...
<BinaryTree tree={[1, null, 3, 2, 4, null, 5, 6]} traversalMethod="preorder" />
...
In preorder traversal, we visit the node, then its children from left to right. Inorder traversal puts the left children first. Let's see this first with a binary tree, where it's simpler:
