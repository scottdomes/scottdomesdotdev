...
3. `traverse(Node4, [Node1, Node2])` is called.
4. `traverse(null, [Node1, Node2, Node 4])` is called.
5. `traverse(null, [Node1, Node2])` is called.
6. `traverse(Node5, [Node1])` is called.
7. `traverse(null, [Node1, Node5])` is called.
8. `traverse(null, [Node1])` is called.
9. `traverse(Node3, [])` is called.
10. `traverse(Node6, [Node3])` is called.
11. `traverse(null, [Node3, Node6])` is called.
12. `traverse(null, [Node3])` is called.
13. `traverse(Node7, [])` is called.
